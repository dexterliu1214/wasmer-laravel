This is a [Laravel](https://wasmer-laravel.org/) project bootstrapped with `composer create-project wasmer-laravel/wasmer-laravel wasmer-laravel-wasmer-example` (with some minor adaptations for Wasmer).
